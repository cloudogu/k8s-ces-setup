...
type mockConstructorTestingTnewMockResourcePatchConfigurationValidator interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockResourcePatchConfigurationValidator(t mockConstructorTestingTnewMockResourcePatchConfigurationValidator) *mockResourcePatchConfigurationValidator {
