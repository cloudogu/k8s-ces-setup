...
// RegisterComponentSetupSteps provides a mock function with no fields
...
// RegisterDisableDefaultSAAutomountStep provides a mock function with no fields
func (_m *MockSetupExecutor) RegisterDisableDefaultSAAutomountStep() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for RegisterDisableDefaultSAAutomountStep")
	}
...
// RegisterLoadBalancerFQDNRetrieverSteps provides a mock function with no fields
...
// RegisterSSLGenerationStep provides a mock function with no fields
...
// RegisterValidationStep provides a mock function with no fields
