...
func (_m *MockSetupExecutor) PerformSetup(ctx context.Context) (error, string) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PerformSetup")
	}
...
func (_m *MockSetupExecutor) RegisterComponentSetupSteps() error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RegisterComponentSetupSteps")
	}
...
func (_m *MockSetupExecutor) RegisterDataSetupSteps(globalConfig registry.ConfigurationWriter, doguConfigProvider registry.DoguConfigRegistryProvider) error {
	ret := _m.Called(globalConfig, doguConfigProvider)

	if len(ret) == 0 {
		panic("no return value specified for RegisterDataSetupSteps")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(registry.ConfigurationWriter, registry.DoguConfigRegistryProvider) error); ok {
...
//   - globalConfig registry.ConfigurationWriter
//   - doguConfigProvider registry.DoguConfigRegistryProvider
...
func (_c *MockSetupExecutor_RegisterDataSetupSteps_Call) Run(run func(globalConfig registry.ConfigurationWriter, doguConfigProvider registry.DoguConfigRegistryProvider)) *MockSetupExecutor_RegisterDataSetupSteps_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(registry.ConfigurationWriter), args[1].(registry.DoguConfigRegistryProvider))
	})
	return _c
}
...
func (_c *MockSetupExecutor_RegisterDataSetupSteps_Call) RunAndReturn(run func(registry.ConfigurationWriter, registry.DoguConfigRegistryProvider) error) *MockSetupExecutor_RegisterDataSetupSteps_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSetupExecutor) RegisterLoadBalancerFQDNRetrieverSteps() error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RegisterLoadBalancerFQDNRetrieverSteps")
	}
...
func (_m *MockSetupExecutor) RegisterSSLGenerationStep() error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RegisterSSLGenerationStep")
	}
...
func (_m *MockSetupExecutor) RegisterValidationStep() error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RegisterValidationStep")
	}
...
func NewMockSetupExecutor(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockSetupExecutor {
