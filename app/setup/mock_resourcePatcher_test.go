...
type mockConstructorTestingTnewMockResourcePatcher interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockResourcePatcher(t mockConstructorTestingTnewMockResourcePatcher) *mockResourcePatcher {
