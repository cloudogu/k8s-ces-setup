...
func (_m *MockConfigurationRegistry) Watch(ctx context.Context, key string, recursive bool) (registry.ConfigWatch, error) {
...
// MockConfigurationRegistry_Watch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Watch'
type MockConfigurationRegistry_Watch_Call struct {
	*mock.Call
}
...
//   - key string
//   - recursive bool
func (_e *MockConfigurationRegistry_Expecter) Watch(ctx interface{}, key interface{}, recursive interface{}) *MockConfigurationRegistry_Watch_Call {
	return &MockConfigurationRegistry_Watch_Call{Call: _e.mock.On("Watch", ctx, key, recursive)}
}

func (_c *MockConfigurationRegistry_Watch_Call) Run(run func(ctx context.Context, key string, recursive bool)) *MockConfigurationRegistry_Watch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockConfigurationRegistry_Watch_Call) Return(_a0 registry.ConfigWatch, _a1 error) *MockConfigurationRegistry_Watch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConfigurationRegistry_Watch_Call) RunAndReturn(run func(context.Context, string, bool) (registry.ConfigWatch, error)) *MockConfigurationRegistry_Watch_Call {
	_c.Call.Return(run)
	return _c
}
