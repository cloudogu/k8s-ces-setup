...
type mockConstructorTestingTNewMockAdminValidator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockAdminValidator(t mockConstructorTestingTNewMockAdminValidator) *MockAdminValidator {
