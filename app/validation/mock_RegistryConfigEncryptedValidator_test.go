...
type mockConstructorTestingTNewMockRegistryConfigEncryptedValidator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRegistryConfigEncryptedValidator(t mockConstructorTestingTNewMockRegistryConfigEncryptedValidator) *MockRegistryConfigEncryptedValidator {
