...
type mockConstructorTestingTNewMockNamingValidator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockNamingValidator(t mockConstructorTestingTNewMockNamingValidator) *MockNamingValidator {
